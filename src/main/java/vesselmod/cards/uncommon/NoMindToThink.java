...
public class NoMindToThink extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "NoMindToThink", //Card ID
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new NoMindToThinkPower(p, this.magicNumber), this.magicNumber));
    }

    @Override
    public AbstractCard makeCopy(){
        return new NoMindToThink();
    }
}
