...
import vesselmod.powers.VoidEmbracePower;
import vesselmod.util.CardInfo;

import static vesselmod.VesselMod.makeID;

public class VoidEmbrace extends BaseCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new VoidEmbracePower(p, this.magicNumber), this.magicNumber));
    }

    @Override
    public AbstractCard makeCopy(){
        return new VoidEmbrace();
    }
}
